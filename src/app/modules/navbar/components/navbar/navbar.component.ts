import { AfterViewInit, Component, ElementRef, OnDestroy, OnInit, TemplateRef, ViewChild, ViewContainerRef, ViewRef } from '@angular/core';
...
export class NavbarComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  @ViewChild('locationTemp', { read: TemplateRef }) locationTemplate: TemplateRef<any>;
  @ViewChild('vCont', { read: ViewContainerRef }) containerRef: ViewContainerRef;
  ...
  debug() {
    if (this.locationViewRef) { this.containerRef.insert(this.locationViewRef); this.locationViewRef = null; }
    else { this.locationViewRef = this.containerRef.detach(); }
  }
