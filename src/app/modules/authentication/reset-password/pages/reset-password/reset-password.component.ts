...
export class ResetPasswordComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.form.controls.confirmPassword.setValidators([CustomValidators.required('Please enter confirm password'), this.confirmPasswordValidator()])
  }
  ...
  submit() {
    ...
    this.restApiService.patch(URL_resetPassword, data).pipe(finalize(() => { this.resetting = false })).subscribe(
      (success) => { this.resetSuccessMessage = success.data; return this.router.navigateByUrl('/signin')},
