...
import { URL_FacebookSignup, URL_forgotPassword, URL_newPassword, URL_SendCodeForgotPassword, URL_SendCodeSignup, URL_Signup, URL_verifyCode } from 'src/api/authentication';
